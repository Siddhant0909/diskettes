...
const Disk = ({ disk, userId }) => {
  ...
  return (
    <div
      className="w-[300px] h-[310px] rounded-xl rounded-br-[60px] px-5 font-caveat relative border-[1px] border-slate-200 shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]"
      style={{ backgroundColor: disk.color }}
    >
      <Link
        to={`/disk/${disk.$id}`}
        className="w-full bg-white h-[70%] rounded-b-xl text-black  p-2 flex flex-col"
      >
      ...
      <div className="flex flex-col relative px-2 py-1 rounded-xl mt-2 text-white bg-[#020202a7]  rounded-br-[50px] overflow-hidden">
        <div>
